export default function SectionDivider() {
  return (
    <div className="flex items-center justify-center my-10 lg:my-16" aria-hidden>
      <span className="h-px w-12 bg-gradient-to-r from-transparent to-ink/20" />
      <svg viewBox="0 0 24 24" className="w-5 h-5 mx-3 text-terracotta" aria-hidden>
      ...
      <span className="h-px w-12 bg-gradient-to-l from-transparent to-ink/20" />
    </div>
  )
}
