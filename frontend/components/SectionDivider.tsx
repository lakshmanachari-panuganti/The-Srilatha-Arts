export default function SectionDivider() {
  return (
    <div className="flex items-center justify-center my-12 lg:my-20" aria-hidden>
      <span className="h-px w-12" style={{ background: 'linear-gradient(to right, transparent, rgba(138,116,201,0.25))' }} />
      ...
      <span className="h-px w-12" style={{ background: 'linear-gradient(to left, transparent, rgba(138,116,201,0.25))' }} />
    </div>
  )
}
